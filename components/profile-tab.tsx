...
import { Settings, ChevronRight, Bell, Moon, HelpCircle, LogOut, Star } from 'lucide-react'
    ...
    <div className="animate-fade-in">
      ...
      <div className="bg-gradient-to-r from-primary/20 to-accent/20 rounded-2xl p-5 mb-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-sm text-primary font-medium">5/7 days</span>
        </div>
        ...
        <p className="text-sm text-muted-foreground">
          {"You're doing great! 2 more healthy meals to reach your goal 💪"}
        </p>
      </div>
